...
describe('schemaRegistry', () => {
  ...
  it('registers exactly the 21 input schemas by name', () => {
    ...
    expect(names).toEqual(
      [
        ...
        'sendMessageSchema',
        'getProcessTemplateInputSchema',
        'findOrCreateCustomerInputSchema',
        'openProcessInputSchema',
        'setProcessFieldsInputSchema',
      ].sort(),
    );
  });
});
