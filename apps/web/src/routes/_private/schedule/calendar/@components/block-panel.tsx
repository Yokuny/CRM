...
// AppointmentCreateForm/appointment-panel.tsx). Sem cabeçalho próprio
// (título + "X") — o botão `Cancelar` do rodapé já fecha o painel, por
// instrução explícita do usuário; mesmo padrão em board-edit-panel.tsx.
          ...
          sections={[
            {
              ...
              fields: [
                ...
                <div key="end" className="grid grid-cols-2 gap-4">
                  <FormField
                    control={form.control}
                    name="endDate"
                    render={({ field }) => (
