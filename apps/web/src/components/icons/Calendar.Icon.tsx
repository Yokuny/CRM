...
// Porte de Calender.Icon.tsx do front de referência (nome com erro de
// digitação lá) — corrigido para "Calendar" aqui, é um arquivo novo neste
// projeto, não uma cópia 1:1 de um caminho já referenciado em outro lugar.
